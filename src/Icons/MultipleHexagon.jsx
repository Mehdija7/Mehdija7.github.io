...
import classes from "./MultipleHexagon.module.css";

const MultipleHexagon = (props) => {
  return (
    <svg
      className={classes.multipleHexagon}
      viewBox="0 0 24 24"
      fill="#ff9999"
      height="20em"
      width="20em"
